...
import imgMovilidad from "@/assets/sec-movilidad.jpg";
...
export const SECRETARIAS_INFO: SecretariaInfo[] = [
  ...
  { slug: "educacion", nombre: "Secretaría de Educación", icon: GraduationCap, enlace: "https://www.medellin.gov.co/es/secretaria-educacion/", descripcion: "Lidera la política educativa, gestiona instituciones públicas y promueve la calidad académica desde la primera infancia hasta la media.", imagen: imgEducacion },
  { slug: "movilidad", nombre: "Secretaría de Movilidad", icon: Bus, enlace: "https://www.medellin.gov.co/movilidad/", descripcion: "Regula el tránsito, promueve la movilidad sostenible y vela por la seguridad vial de peatones, ciclistas y conductores.", imagen: imgMovilidad },
  { slug: "hacienda", nombre: "Secretaría de Hacienda", icon: Wallet, enlace: "https://www.medellin.gov.co/es/secretaria-hacienda/", descripcion: "Administra los recursos financieros del Distrito, recauda impuestos y gestiona el presupuesto público con transparencia.", imagen: imgHacienda },
  { slug: "gobierno", nombre: "Secretaría de Gobierno", icon: Landmark, enlace: "https://www.medellin.gov.co/es/secretaria-gobierno/", descripcion: "Coordina la convivencia ciudadana, las relaciones políticas y la gestión territorial del Distrito de Medellín.", imagen: imgGobierno },
  { slug: "seguridad", nombre: "Secretaría de Seguridad y Convivencia", icon: Shield, enlace: "https://www.medellin.gov.co/es/secretaria-seguridad/", descripcion: "Diseña estrategias de prevención del delito y promueve una cultura de paz, denuncia y convivencia ciudadana.", imagen: imgSeguridad },
  ...
  { slug: "general", nombre: "Secretaría General", icon: Building2, enlace: "https://www.medellin.gov.co/es/secretaria-general/", descripcion: "Coordina la gestión documental, jurídica y administrativa de toda la Alcaldía.", imagen: imgGeneral },
