  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-white p-1.5 shadow-[var(--shadow-elegant)] animate-pulse-ring transition-transform hover:scale-105"
      >
        <img src={accessibilityIcon} alt="Accesibilidad" className="h-full w-full object-contain" />
      </button>
    </div>
  );
}
